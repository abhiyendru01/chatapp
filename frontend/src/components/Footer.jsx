  ...
  return (
    <div className="flex justify-center items-center relative transition-all duration-[450ms] ease-in-out w-full p-4">
      <div className="border border-solid border-base-300 w-full ease-in-out duration-500 left-0 rounded-2xl flex shadow-lg bg-base-100">
        <label
          className="relative w-full h-16 p-4 ease-in-out duration-300 border-solid border-black/10 group flex flex-row gap-3 items-center justify-center text-black rounded-xl cursor-pointer"
          htmlFor="dashboard"
        >
          ...
          <svg
            ...
            className="peer-hover:scale-110 peer-hover:text-primary-content peer-checked:text-primary-content text-2xl peer-checked:scale-110 transition-all duration-300"
          >
