...
const ProfilePage = () => {
  ...
  const handleImageUpload = (e) => {
    ...
    reader.onload = () => {
      ...
      setSelectedImg(base64Image); // Update preview immediately
    };
  ...
  const handleSave = async () => {     
    ...
    try {       
      // Update profile with name and/or profile picture       
      await updateProfile({         
      ...
      Swal.fire({
        ...
        customClass: {
          popup: 'backdrop-blur-sm bg-black bg-opacity-60 rounded-lg text-white', // Tailwind classes for blur, opacity, and rounded corners
        },
